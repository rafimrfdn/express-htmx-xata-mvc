...
const writeFileMock = writeFile;
const readFileMock = readFile;
const statMock = stat;
...
const cliUpdateAvailable = `"✨ A newer version of @xata.io/cli is now available: ${latestAvailableVersionCLI}. You are currently using version: ${semver.coerce(userVersionCLI)}"`;
const sdkUpdateAvailable = `"✨ A newer version of @xata.io/client is now available: ${latestAvailableVersionSDK}. You are currently using version: ${semver.coerce(userVersionSDK)}"`;
const cliError = `"Incompatible version of @xata.io/cli: ${semver.coerce(userVersionCLI)}. Please upgrade to a version that satisfies: >=${latestAvailableVersionCLI}||${specificVersionCLI}."`;
const sdkError = `"Incompatible version of @xata.io/client: ${semver.coerce(userVersionSDK)}. Please upgrade to a version that satisfies: ${latestAvailableVersionSDK}."`;
...
const packageJsonObj = (withPackage) => {
    return {
        name: 'client-ts',
