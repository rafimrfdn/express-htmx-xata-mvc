...
import { allMigrationsPgRollFormat, getBranchDetailsWithPgRoll, isBranchPgRollEnabled, isMigrationPgRollFormat } from '../../migrations/pgroll.js';
...
class Push extends BaseCommand {
    async run() {
        ...
        if (!confirm)
            return this.exit(1);
        if (isBranchPgRollEnabled(details)) {
            const migrationsToPush = newMigrations
