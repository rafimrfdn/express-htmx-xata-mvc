...
class DatabasesRename extends BaseCommand {
    async run() {
...
_a = DatabasesRename;
DatabasesRename.description = 'Rename a database';
DatabasesRename.examples = [];
DatabasesRename.flags = {
    ..._a.commonFlags,
...
DatabasesRename.enableJsonFlag = true;
export default DatabasesRename;
