...
export const isValidJavascriptVariable = (variable) => VALID_JAVASCRIPT_VARIABLE.test(variable);
// We support table names which aren't valid javascript variables e.g. 'table-2' `xata.db.table-2` is not valid.
export const getDbTableExpression = (table) => isValidJavascriptVariable(table) ? `.${table}` : `['${table}']`;
